...
public class DocumentationAnalyzer {
    ...
    public static void main(String[] args) {
        ...
        analyzeDocumentation(Car.class);
        analyzeDocumentation(Food.class);
        analyzeDocumentation(Sleep.class);
        analyzeDocumentation(Walk.class);
        analyzeDocumentation(Singing.class);
        printInconsistencies();
        writeDocumentationToFile("extractedDocumentation.txt");
    }
